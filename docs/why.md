...
`go-ruby-slim/slim` reimplements Ruby's `slim` in **pure Go, with cgo disabled**. The slice of
...
- any Go program can import `github.com/go-ruby-slim/slim` directly, with no Ruby runtime;
