...
Contributions are welcome. `go-ruby-slim/slim` is built to a small set of
...
The library is in [`github.com/go-ruby-slim/slim`](https://github.com/go-ruby-slim/slim).
This documentation site is in [`github.com/go-ruby-slim/docs`](https://github.com/go-ruby-slim/docs).
