# go-ruby-slim documentation

**Pure-Go (CGO=0) MRI-faithful Ruby slim**

`go-ruby-slim/slim` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `slim`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `slim`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`slim`](https://github.com/go-ruby-slim/slim) | the library — Ruby's `slim` in pure Go |
| [`docs`](https://github.com/go-ruby-slim/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-slim.github.io`](https://github.com/go-ruby-slim/go-ruby-slim.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-slim/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-slim/slim](https://github.com/go-ruby-slim/slim).
